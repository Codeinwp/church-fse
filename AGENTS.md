# Agent Guide — Church FSE

## Overview

Church FSE is a block-based WordPress theme built for Full Site Editing. PHP theme code lives in the `ChurchFSE` namespace under `inc/`; the theme also provides block patterns, templates, template parts, styles, and JavaScript and SCSS assets.
...
- Put PHP theme behavior in the existing `ChurchFSE` namespace and preserve the current class structure.
